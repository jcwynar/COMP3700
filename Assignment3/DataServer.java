    ...
    public void run()
    {
        ...
        while (true) {
            try {
                ...
                else if (req.code == RequestModel.SAVE_NOTE_REQUEST) {
                ...
                else if (req.code == RequestModel.SEARCH_NOTE_REQUEST) {
                    String key = req.body;

                    System.out.println("The Client asks for a note containing keyword = " + key);

                    NoteListModel list = dao.searchNote(key);
